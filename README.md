...
It supports optional parameters:
 ...
 - `columns_from` (`header`, `auto`) -- Populates the `columns` attribute
   - `header` -- Uses the first line of the CSV file (or of any of the slices) as the column names. If any of the headers is empty (empty string), then auto-generated names are used. 
